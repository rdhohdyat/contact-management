...
export default function ConctactDetail() {
  ...
  useEffectOnce(() => {
    fetchContact().then(() => console.log("success get conttact detail"));
    fetchAdresses().then(() => console.log("success get list address"));
  });
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="bg-gray-700 bg-opacity-50 p-5 rounded-lg border-2 border-dashed border-gray-600 shadow-md card-hover">
                <Link to="address/create" className="block h-full">
