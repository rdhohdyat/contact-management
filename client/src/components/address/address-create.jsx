...
import { addressCreate } from "../../lib/api/address-api";
...
export default function AddressCreate() {
  ...
  const handleSubmitAddress = async (e) => {
    ...
    const { street, city, province, country, postal_code } = formData;
  ...
  useEffectOnce(() => {
    fetchContactDetail().then(() =>
      console.log("get detail contact is succesfully")
    );
  });
